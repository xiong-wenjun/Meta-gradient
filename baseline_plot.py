...
def plot_baseline(npy_file):
    ...
    plt.grid(True)
    plt.legend()
    plt.savefig("baseline_curve.png", dpi=200)
    plt.show()

    print("绘图完成，已保存为 baseline_curve.png")


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--file", type=str, required=False, default="/gemini/code/project/2025_11_21_13_45_01.npy",
