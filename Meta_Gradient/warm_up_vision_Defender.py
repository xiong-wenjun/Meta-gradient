...
#  Meta-Training Step
# ---------------------------
def meta_train_step(agent, optimizer_inner, optimizer_meta, batch_train, batch_valid, current_lr, perform_meta=True):
    # 1. Prepare Data
...
def run(seed=42):
    ...
    try:
        while total_frames < MAX_FRAMES:
            ...
            do_meta = total_frames > 5_000_000  # Warm-up period before meta-update
            loss, g, l = meta_train_step(agent, optimizer_inner, optimizer_meta, b_train, b_valid, curr_lr, perform_meta=do_meta)
